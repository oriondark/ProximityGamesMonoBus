...
export class ListPage implements OnInit {
    ...
    async modify(item, i) {
        ...
        const onDismissPromise = this.modal.onDidDismiss();
        // onDismissPromise.then((data) => {
        //   console.log(data);
        // });
        onDismissPromise.then((result) => {
                console.log('called dismissed');
